...
export default function MultilistFilter({ value, applyFilter, filterKey }: { value: FilterDefinition, applyFilter: (value1: string, value2: string) => void, filterKey: string }) {
